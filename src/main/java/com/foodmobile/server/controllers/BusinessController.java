...
public class BusinessController {
    ...
    public DataModelResponse<Company> createCompany(@RequestParam String name, @RequestParam String financialInfo, @RequestParam String dietaryInfo) {
        var company = Company.create(name, financialInfo, dietaryInfo);
        try (var dao = new DAO()) {
            dao.create(company);
